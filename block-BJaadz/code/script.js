...
allHrsArray.forEach(n => n.style.border= "1px solid tomato")
// Change the background of all the hr to "antiquewhite" using for of loop.
for(let i of allHrsArray) {
  i.style.backgroundColor = "antiquewhite"
}
// Change the 'border-radius' of all the hr to "5px" using array.
allHrsArray.map(n => n.style.borderRadius = "5px")
...
// Hide the box number 17 (last box).
 let s = document.querySelector(".seventeen")
s.style.display = "none"
// Change the border of all the hr element from solid to dashed type
allHrsArray.forEach(n=> n.style.border = "dashed")
...
console.dir(box16.parentNode);
console.dir(box16.childNodes);
console.dir(box16.previousSibling);
console.dir(box16.nextSibling);
console.dir(box16.firstChild);
console.dir(box16.lastChild);
console.dir(box16.previousElementSibling);
console.dir(box16.nextElementSibling);
console.dir(box16.firstElementChild);
console.dir(box16.lastElementChild);
